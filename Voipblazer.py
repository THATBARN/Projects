...
login.find_element(By.XPATH, "div[2]/form/table/tbody/tr[1]/td[2]/input").send_keys("thanks84")
login.find_element(By.XPATH, "div[2]/form/table/tbody/tr[2]/td[2]/input").send_keys("sister84")
...
if b < 700:
    TOKEN = "5718569127:AAH-38l5rJl-JsEcSVd1YlEeBpQprkFqndY"
    bot = telebot.TeleBot(TOKEN) 
    bot.send_message(5494804052, 'ALERT: BALANCE IS LOW: ' + balance)
